...
import CallReport from "../components/CallReport.vue";
...
const defaultReportData = {
  ...
  candidates_status: [],
  callcenter: {
    total_call_out_answer_duration: {},
    total_call_in_answer_duration: {},
...
const REPORTCARDS = [
  { title: "Tổng lao động", statKey: "total_workers" },
  { title: "Tổng ứng viên", statKey: "total_candidates" },
  { title: "Tổng lịch hẹn", statKey: "total_appointment_candidates" },
  { title: "Tổng đến phỏng vấn", statKey: "total_interview_candidates" },
];

const chartRevenueType = ref("total_workers");
            ...
            <div class="flex-grow-1 ps-2 pt-1">
              <div class="d-flex">
                ...
                <div class="flex-grow-1">
                  <h4 class="fs-16 mb-1">BÁO CÁO PHÒNG TELESALES!</h4>
      ...
      <div class="card mb-1" style="max-height: 550px; height: 450px">
        <div class="row h-100 d-flex flex-column">
          ...
          <div class="col-12 col-md-4">
            <PieChart :chart-data="reportData.candidates_status"></PieChart>
          </div>
          <div class="col-12 col-md-4 h-100">
            <CallReport v-bind="{ ...reportData.callcenter }"></CallReport>
          </div>
        </div>
      </div>
      <div class="card mb-1">
        <RankingReport :data="reportData.recruitment_rank"></RankingReport>
      </div>
    </div>
  </div>
  <!-- </div>

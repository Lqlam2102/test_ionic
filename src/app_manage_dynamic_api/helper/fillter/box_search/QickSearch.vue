        ...
        <div class="col-12 col-md-4 px-0 border-end">
          <div class="card-body border-bottom pb-1">
            <div class="d-flex gap-2">
              <div class="d-flex gap-2">
                <i
                  class="las la-filter label-icon align-middle text-primary fs-20"
                ></i>
            ...
            >
              <i
                class="me-2 align-bottom fs-16 fw-bold text-muted"
                style="width: 20px"
              >
              </i>
            ...
            <div
              class="d-flex text-bg-white text-nowrap align-items-center btn btn-ghost-dark ps-0"
              style="height: 28px"
              @click="handleClickShowModalFilter"
            >
              <i
                class="ri-settings-2-line me-2 align-bottom fs-16 fw-bold text-muted"
                style="width: 20px"
              >
              </i>
              <span class="fw-light text-nowrap">
        ...
        <div class="col-12 col-md-4 px-0 border-end">
          <div class="card-body border-bottom pb-1">
            <div class="d-flex gap-2">
              <div class="d-flex gap-2">
                <i
                  class="las la-object-group label-icon align-middle text-success fs-20"
                ></i>
            ...
            <div
              class="ps-0 d-flex text-bg-white text-nowrap align-items-center btn btn-ghost-dark ps-0"
              style="height: 28px"
            >
              <i
                class="ri-settings-2-line me-2 align-bottom fs-16 fw-bold text-muted"
        ...
        <div class="col-12 col-md-4 px-0 border-end">
          <div class="card-body border-bottom pb-1">
            <div class="d-flex gap-2">
              <div class="d-flex gap-2">
                <i
                  class="las la-star label-icon label-icon align-middle text-warning fs-20"
                ></i>
            ...
            >
              <i
                class="ri-settings-2-line me-2 align-bottom fs-16 fw-bold text-muted ps-0"
                style="width: 20px"
              >
              </i>

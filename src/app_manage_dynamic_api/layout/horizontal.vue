  ...
  <div>
    <div id="layout-wrapper">
      ...
      <div class="app-menu navbar-menu">
        ...
        <div id="scrollbar">
          <b-container fluid>
            <ul class="navbar-nav h-100 justify-content-center" id="navbar-nav">
              <li class="menu-title">
                    ...
                    <li class="nav-item">
                      ...
                      <div class="collapse menu-dropdown" id="sidebarjobs">
                        <ul class="nav nav-sm flex-column">
                          ...
                          <li class="nav-item">
                            <b-link href="#sidebarjoblists" class="nav-link" data-bs-toggle="collapse" role="button"
                          ...
                          <li class="nav-item">
                            <b-link href="#sidebarcandidatelists" class="nav-link" data-bs-toggle="collapse"
    ...
    $t("t-authentication")
              ...
              <li class="nav-item">
                <b-link href="#sidebarlanding" class="nav-link" data-bs-toggle="collapse" role="button"
                ...
                <div class="collapse menu-dropdown" id="sidebarlanding">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
                      <b-link class="nav-link menu-link" target="_blank" href="/landing">
                        <span data-key="t-landing">{{ $t("t-one-page") }}</span>
                      </b-link>
                    </li>
                    <li class="nav-item">
                      <b-link class="nav-link menu-link" target="_blank" href="/nft-landing">
                        <span data-key="t-landing">{{ $t("t-nft-landing") }}</span>
                      </b-link>
                    </li>
                    <li class="nav-item">
                      <b-link class="nav-link menu-link" target="_blank" href="/job-landing">
              ...
              <li class="nav-item">
                <b-link class="nav-link active" href="#sidebarMore" data-bs-toggle="collapse" role="button"
                ...
                <div class="collapse menu-dropdown show" id="sidebarMore">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
                      <b-link class="nav-link menu-link" href="#sidebarAdvanceUI" data-bs-toggle="collapse"
                        role="button" aria-expanded="false" aria-controls="sidebarAdvanceUI">
                        <i class="ri-stack-line"></i>
                        <span data-key="t-advance-ui">{{
    $t("t-advance-ui")
}}</span>
                        <b-badge variant="success" class="badge-pill bg-success" data-key="t-new">{{ $t("t-new")
}}</b-badge>
                      </b-link>
                    ...
                    <li class="nav-item">
                      <b-link class="nav-link menu-link" href="#sidebarMaps" data-bs-toggle="collapse" role="button"
                    ...
                    <li class="nav-item">
                      <b-link class="nav-link menu-link" href="#sidebarMultilevel" data-bs-toggle="collapse"

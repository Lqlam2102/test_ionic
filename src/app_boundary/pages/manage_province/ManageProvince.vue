...
const handleClickView = ($event) => {
  ...
  type.value = "view"
  handleGetPolygon("province", item.id)
}
  ...
  <Layout :address="address" :items="address.details" chooseMenu="ban-do" :slug="props.slug">
    <LayoutDemo toolbarId="Province">
      ...
      <template v-slot:actions-field>
        <li>
          <div class="dropdown-item" data-bs-toggle="offcanvas" data-bs-target="#offcanvasProvince-view"
            @click="handleClickView" aria-controls="#offcanvasProvince-view">
            <i class="ri-eye-fill align-bottom me-2 text-muted"></i>
            Xem chi tiết
          </div>
        </li>
        <li>
          <div class="dropdown-item" data-bs-toggle="offcanvas" data-bs-target="#offcanvasProvince-update"
            @click="handleClickUpdate" aria-controls="#offcanvasProvince-update">

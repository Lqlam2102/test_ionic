...
const handleClickView = ($event) => {
  ...
  type.value = "view";
  handleGetPolygon("commune", item.id);
};
      ...
      <template v-slot:actions-field>
        <li>
          <div
            ...
            data-bs-target="#offcanvasCommune-view"
            @click="handleClickView"
            aria-controls="#offcanvasCommune-view"
          >
        ...
        <li>
          <div
            class="dropdown-item"
            data-bs-toggle="offcanvas"
            data-bs-target="#offcanvasCommune-update"
            @click="handleClickUpdate"
            aria-controls="#offcanvasCommune-update"
          >

...
const handleClickView = ($event) => {
  ...
  type.value = "view"
  handleGetPolygon("district", item.id)
}
  ...
  <Layout :address="address" :items="address.details" chooseMenu="ban-do" :slug="props.slug">
    <LayoutDemo toolbarId="District">
      ...
      <template v-slot:actions-field>
        <li>
          <div class="dropdown-item" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDistrict-view"
            @click="handleClickView" aria-controls="#offcanvasDistrict-view">
            <i class="ri-eye-fill align-bottom me-2 text-muted"></i>
            Xem chi tiết
          </div>
        </li>
        <li>
          <div class="dropdown-item" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDistrict-update"
            @click="handleClickUpdate" aria-controls="#offcanvasDistrict-update">

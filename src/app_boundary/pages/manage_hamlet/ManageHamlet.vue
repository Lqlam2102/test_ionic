...
const handleClickView = ($event) => {
  ...
  type.value = "view"
  handleGetPolygon("hamlet", item.id)
}
  ...
  <Layout :address="address" :items="address.details" chooseMenu="ban-do" :slug="props.slug">
    <LayoutDemo toolbarId="Hamlet">
      ...
      <template v-slot:actions-field>
        <li>
          <div class="dropdown-item" data-bs-toggle="offcanvas" data-bs-target="#offcanvasHamlet-view"
            @click="handleClickView" aria-controls="#offcanvasHamlet-view">
            <i class="ri-eye-fill align-bottom me-2 text-muted"></i>
            Xem chi tiết
          </div>
        </li>
        <li>
          <div class="dropdown-item" data-bs-toggle="offcanvas" data-bs-target="#offcanvasHamlet-update"
            @click="handleClickUpdate" aria-controls="#offcanvasHamlet-update">

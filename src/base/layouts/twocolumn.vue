...
import Menu from "@/base/components/menu.vue";
import NavBar from "@/base/components/nav-bar";
import RightBar from "@/base/components/right-bar";
          ...
          <b-container fluid>
            <div id="two-column-menu">
              <SimpleBar class="twocolumn-iconview list-unstyled">
                <b-link href="#" class="logo"><img :src="ConfigSystem.logo" alt="Logo" height="22" /></b-link>
                <li>
                ...
                <li class="nav-item">
                  <div class="collapse menu-dropdown" id="sidebarApps">
                    <ul class="nav nav-sm flex-column">
                      ...
                      <li class="nav-item">
                        <b-link href="#jobs" class="nav-link" data-bs-toggle="collapse" role="button"
                          aria-expanded="false" aria-controls="jobs" data-key="t-jobs">
                          {{ $t("t-jobs") }}
                          <b-badge variant="success" class="badge-pill" data-key="t-new">{{
    $t("t-new")
}}</b-badge>

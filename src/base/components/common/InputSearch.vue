...
import { TextSearchAPIMap4D } from "@/base/common/map/function_map.js";
import { debounce } from "@/base/common/common.js";
...
<template>
  <div class="bar d-flex position-relative">
    ...
    />
    <button class="search-btn" type="button" @click="handleClickIcon">
      <span>Search</span>
    </button>
    <div

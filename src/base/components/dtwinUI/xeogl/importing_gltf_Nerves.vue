...
onMounted(() => {
  ...
  var model = new xeogl.GLTFModel({
    ...
    handleNode: (function () {
      // Callback fired for each glTF scene node
      var objectCount = 0;
      return function (nodeInfo, actions) {
        if (nodeInfo.mesh !== undefined) {
          // glTF node has a mesh
          actions.createObject = {
            // Create a xeogl.Object for this glTF scene node
...
<template>
  <div id="info">
    <h1>
      <a href="../docs/classes/GLTFModel.html" target="_parent">GLTFModel</a>
      - anatomical model with occlusion-culled
      <a href="../docs/classes/Annotation.html" target="_parent">Annotations</a>
    </h1>

...
const unassigned = [{
    ...
    features: ["Admin"],
    users: [require("@/assets/images/users/user-dummy-img.jpg"), require("@/assets/images/users/user-dummy-img.jpg")],
    id: "#VL2436",
    watch: "04",
    message: "19",
    file: "2"
},
{
    ...
    users: [require("@/assets/images/users/user-dummy-img.jpg"), require("@/assets/images/users/user-dummy-img.jpg"), require("@/assets/images/users/user-dummy-img.jpg")],
    id: "#VL2436",
    watch: "04",
    message: "19",
    file: "2",
...
},
{
    ...
    users: [require("@/assets/images/users/user-dummy-img.jpg"), require("@/assets/images/users/user-dummy-img.jpg"), require("@/assets/images/users/user-dummy-img.jpg"), require("@/assets/images/users/user-dummy-img.jpg")],
    id: "#VL2436",
    watch: "64",
    message: "35",
    file: "23",

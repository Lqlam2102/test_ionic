                            ...
                            <b-row class="justify-content-center g-0">
                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            <div class="mb-4">
                                                <b-link href="/" class="d-block">
                                                    <img src="@/assets/images/logo/lmhtx_logo.png" alt="" height="40">
                                                </b-link>
                                            </div>
                                            <div class="mt-auto">
                                                <div class="mb-3">
                                                ...
                                                <div id="qoutescarouselIndicators" class="carousel slide"
                                                    ...
                                                    <div class="carousel-inner text-center text-white-50 pb-5">
                                                        <div class="carousel-item active">
                                                            <p class="fs-15 fst-italic">" LMHTX - Liên minh hợp tác xã Việt
                                                                Nam "</p>
                                                        </div>
                                ...
                                <b-col lg="6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <p class="text-muted">Mật khẩu mới của bạn phải khác với mật khẩu đã sử dụng trước
                                            đó.</p>
                                            ...
                                            <form>
                                                <b-row>
                                                    <b-col lg="6" class="mb-3">
                                                        <label class="form-label">Tài khoản người
                                                            dùng</label>
                                                        <input type="text" class="form-control pe-5"
                                                            v-model="infoUser.username" disabled>
                                                    </b-col>
                                                    <b-col lg="6" class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup">
                                                        <input :type="showPass.old ? 'text' : 'password'"
                                                            class="form-control pe-5 password-input" v-model="currPass"
                                                            id="password-input" placeholder="Nhập mật khẩu hiện tại"
                                                            :class="{ 'is-invalid': attemptSubmit && missingCurrPass || attemptSubmit && checkPass }">
                                                        <button @click="showPass.old = !showPass.old" type="button"
                                                            id="password-addon"
                                                            class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon"
                                                            :class="{ 'me-3': attemptSubmit && missingCurrPass || attemptSubmit && checkPass }">
                                                            <i class="align-middle"
                                                                :class="showPass.old ? 'ri-eye-off-fill' : 'ri-eye-fill'"></i>
                                                        </button>
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup">
                                                        <input :type="showPass.new ? 'text' : 'password'"
                                                            class="form-control pe-5 password-input" v-model="newPass"
                                                            placeholder="Nhập mật khẩu mới" id="new-password-input"
                                                            :class="{ 'is-invalid': attemptSubmit && missingNewPass || attemptSubmit && passSameOld }">
                                                        <button type="button" id="new-password-addon"
                                                            @click="showPass.new = !showPass.new"
                                                            class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon"
                                                            :class="{ 'me-3': attemptSubmit && missingNewPass || attemptSubmit && passSameOld }">
                                                            <i class="align-middle"
                                                                :class="showPass.new ? 'ri-eye-off-fill' : 'ri-eye-fill'"></i>
                                                        </button>
                                                    </div>
                                                    <div class="invalid-feedback d-block"
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label" for="confirm-new-password-input">Xác nhận mật
                                                        khẩu mới <span class="text-danger">*</span></label>
                                                    <div class="position-relative auth-pass-inputgroup">
                                                        <input :type="showPass.renew ? 'text' : 'password'"
                                                            class="form-control pe-5 password-input" v-model="rePass"
                                                        ...
                                                        <button @click="showPass.renew = !showPass.renew" type="button"
                                                            ...
                                                            <i class="align-middle"
                                                                :class="showPass.renew ? 'ri-eye-off-fill' : 'ri-eye-fill'"></i>
                                                        </button>
                                                    </div>
                                                    <div class="invalid-feedback d-block"
                ...
                <b-row>
                    <b-col lg="12">
                        <div class="text-center">
                            <p class="mb-0">&copy; {{ new Date().getFullYear() }} DTwin Team. Design & Develop by DTwin Team
                            </p>
                        </div>
                    </b-col>
                </b-row>

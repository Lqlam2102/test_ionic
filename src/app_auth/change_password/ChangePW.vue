              ...
              <b-row class="justify-content-center g-0">
                    ...
                    <div class="position-relative h-100 d-flex flex-column">
                      <div class="mb-4">
                        <b-link href="/" class="d-block">
                          <img
                            src="@/assets/images/logo/lmhtx_logo.png"
                            alt=""
                            height="40"
                          />
                        </b-link>
                          ...
                          >
                            <div class="carousel-item active">
                              <p class="fs-15 fst-italic">
                                " LMHTX - Liên minh hợp tác xã Việt Nam "
                              </p>
                            </div>
                ...
                <b-col lg="6">
                  <div class="p-lg-5 p-4">
                    ...
                    <p class="text-muted">
                      Mật khẩu mới của bạn phải khác với mật khẩu đã sử dụng
                      trước đó.
                    </p>
                      ...
                      <form>
                        ...
                        <div class="mb-3">
                          ...
                          <div
                            class="invalid-feedback d-block"
                            v-if="
                              attemptSubmit && passNotMatch && rePass !== ''
                            "
                          >

                ...
                <b-col lg="6">
                  ...
                  <div v-else-if="stateSite === 2" class="p-lg-5 p-4">
                    ...
                    <p class="text-muted fst-italic">Chưa nhận được mã?
                      <span class="fw-semibold text-primary text-decoration-underline cursor-pointer">Nhấn vào đây </span>
                      để nhận lại mã
                    </p>
                  </div>
                  ...
                  <div v-else class="p-lg-5 p-4">
                    <div class="text-center py-5">
                      ...
                      <router-link type="button" class="btn btn-success mt-4" :to="{ name: 'Login' }">Đăng nhập ngay
                      </router-link>
                    </div>
                  </div>
                </b-col>

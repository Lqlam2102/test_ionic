...
watch(notiConfigToEdit, () => {
    notiConfigStore.notiConfigToEdit.value = notiConfigToEdit
})
                ...
                <b-row>
                    ...
                    <b-col lg="6" class="mb-2">
                        ...
                        <input type="text" class="form-control" id="nameSystemConfigInput" placeholder="Nhập tên cấu hình"
                            v-model="notiConfigToEdit.name" autocomplete="new-name"
                            :class="{ 'is-invalid': !notiConfigToEdit.name }" />
                        <div class="invalid-feedback d-block" v-if="!notiConfigToEdit.name">
                    ...
                    <b-col lg="6" class="mb-2">
                        ...
                        <input type="text" class="form-control" id="manageUnitInput" placeholder="Nhập email thông báo"
                            ...
                            :class="{ 'is-invalid': !notiConfigToEdit.email }" />

                        <div class="invalid-feedback d-block" v-if="!notiConfigToEdit.email">
                            Vui lòng nhập email
                        </div>
                    </b-col>
                    <b-col lg="6" class="mb-2">
                        ...
                        <div class="position-relative auth-pass-inputgroup">
                            <input :type="showPassword ? 'text' : 'password'" class="form-control pe-5 password-input"
                                ...
                                v-model="notiConfigToEdit.password" :class="{ 'is-invalid': !notiConfigToEdit.password }" />
                        ...
                        <div class="invalid-feedback d-block" v-if="!notiConfigToEdit.password">

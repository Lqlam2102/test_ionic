...
const obj = reactive({
    ...systemConfigStore.baseObject,
    have_new_logo: false,
    have_new_banner: false
})
...
watch(obj, () => {
    systemConfigStore.systemConfigToEdit.value = obj
})
</script>
<template>
    <form action="#">
                        ...
                        <b-row>
                            <b-col lg="12" class="mb-2">
                                ...
                                <div class="img-upload-slot">
                                    ...
                                    <input class="form-control" type="file" id="formFileLogoInput_edit"
                                        @change="onChangeLogo" style="display: none;">
                                    <label for="formFileLogoInput_edit" class="label-upload-img"><i
                            ...
                            <b-col lg="12" class="mb-2">
                                ...
                                <div class="img-upload-slot">
                                    ...
                                    <input class="form-control" type="file" id="formFileBannerInput_edit"
                                        @change="onChangeBanner" style="display: none;">
                                    <label for="formFileBannerInput_edit" class="label-upload-img"><i
                                            class="bx bx-camera fs-20"></i></label>
                                </div>
                            </b-col>
                        </b-row>

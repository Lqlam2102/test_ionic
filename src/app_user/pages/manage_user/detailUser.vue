...
watch(userStore.currentUser, () => {
  ...
  userToEdit.social_network_link = currentUser.social_network_link;
...
// Fetch all groups
useFetch(`${BASE_URL}/api/group/?all`).then(
  (res) => {
...
const getDepartmentName = () => {
  if (!userToEdit.department) return "Không thuộc phòng ban nào";
  if (!userToEdit.department?.length) return "Không thuộc phòng ban nào";
  if (userToEdit.department[0]?.name) return userToEdit.department[0].name;
};
</script>
<template>
  <form action="#">
            ...
            <b-row>
              ...
              <b-col lg="6" class="mb-3">
                ...
                <div class="img-upload-slot">
                  ...
                  <!-- <input class="form-control" type="file" id="formFileLogoInput" @change="onChangeUserLogo"
                  style="display: none;">
                <label for="formFileLogoInput" class="label-upload-img"><i class="bx bx-camera fs-20"></i></label> -->
                </div>
              </b-col>
              <!-- Email -->
              <b-col lg="6" class="mb-3">
          ...
          <AccordionRecord title="QUYỀN NGƯỜI DÙNG">
            <b-row>
              ...
              <b-col lg="6" class="mb-3">
                ...
                <select
                  class="form-select"
                  v-model="userToEdit.user_role"
                  disabled
                >
                  <option v-for="role in listRole" :value="role.id" :key="role">
                    {{ role.name }}
                  </option>
                </select>
              </b-col>
          ...
          <label for="usernameInput" class="form-label mb-1">
            Tài khoản đăng nhập StringeeX
              ...
              <input
                ...
                autocomplete="new-username" disabled
                />
        </b-col>
        <b-col md="6" class="mb-3">                
          <label for="usernameInput" class="form-label mb-1">
              ...
              <b-col md="6">
                <div class="mb-3 d-flex">
                  ...
                  <input
                    ...
                    class="form-control"
                    :value="
                      userToEdit.social_network_link?.tiktok ?? 'Chưa liên kết'
                    "
              ...
              <b-col md="6">
                <div class="mb-3 d-flex">
                  ...
                  <input
                    ...
                    class="form-control"
                    :value="
                      userToEdit.social_network_link?.zalo ?? 'Chưa liên kết'
                    "

              ...
              <b-card-body class="p-4">
                <div class="text-center">
                  <div class=" profile-user position-relative d-inline-block mx-auto mb-4 ">
                    ...
                    <img :src="preveiw_image_upload" class=" rounded-circle avatar-xl img-thumbnail user-profile-image"
                  ...
                  <h5 class="fs-16 mb-1">{{ infoUser?.first_name }} {{ infoUser?.last_name }}</h5>
              ...
              <b-card-body>
                ...
                <div class="mb-3 d-flex">
                  ...
                  <input type="text" class="form-control" id="websiteInput"
                    placeholder="Link to Faceook" v-model="userFacebook">
                </div>
                <div class="mb-3 d-flex">
                  <div class="avatar-xs d-block flex-shrink-0 me-3">
                  ...
                  <input type="email" class="form-control" id="gitUsername" placeholder="Link to Github"
                    v-model="userGitHub">
                </div>
              </b-card-body>
            </b-card>
          ...
          <b-col xxl="8">
            <b-card no-body class="mt-xxl-n5">
              <b-card-header class="d-flex align-items-center">
                ...
                <router-link to="/profile" type="button" v-b-tooltip.hover title="Đóng"
                  class="flex-shrink-0 btn btn-ghost-primary btn-close"></router-link> -->
                <div class="card-title mb-0 flex-grow-1 gap-10">
                  <button type="button" class="btn btn-soft-primary waves-effect waves-light me-2">
                    Chỉnh sửa
                  </button>
                  <button type="button" class="btn btn-warning btn-icon waves-effect waves-light"
                    @click.prevent="handleSubmit(infoUser.id)"><i class="ri-save-2-fill"></i></button>
                </div>
                <router-link to="/profile/detail" class="btn btn-outline-primary btn-icon waves-effect waves-light">
                ...
                <b-row>
                  ...
                  <b-col lg="6">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="lastnameInput" name="last_name" placeholder="Nhập tên"
                    ...
                    <div class="mb-3">
                      ...
                      <div class="input-group">
                        <input type="tel" class="form-control"
                          ...
                          id="phonenumberInput" name="phone" placeholder="Nhập số điện thoại" v-model="infoUser.phone">
                  ...
                  <b-col lg="6">
                    <div class="mb-3">
                      ...
                      <input type="date" class="form-control" id="exampleInputdate" v-model="infoUser.birth"
                        @change="changeBirth">
                    </div>
                  </b-col>
                  <b-col lg="6">
                  ...
                  <b-col lg="6">
                    <div class="mb-3">
                      <label for="stringeex_idInput" class="form-label">Tài khoản stringeeX</label>
                      <input type="text" class="form-control" id="stringeex_idInput" name="stringeex_id"
                        placeholder="Nhập Tài khoản stringeeX" v-model="infoUser.stringeex_id">
                    </div>
                  </b-col>
                  <b-col lg="6">
                    <div class="mb-3">
                      <label for="stringeex_passwordInput" class="form-label">Mật khẩu stringeeX</label>
                      <input type="text" class="form-control" id="stringeex_passwordInput" name="stringeex_password" placeholder="Nhập Mật khẩu stringeeX"
                        v-model="infoUser.stringeex_password">
                    </div>
                  </b-col>
                  <b-col lg="12">
                    <div class="mb-3">
                  ...
                  <b-col lg="12">
                    <div class="mb-3 pb-2">
                      ...
                      <textarea class="form-control" id="exampleFormControlTextarea" rows="6" v-model="infoUser.introduce"
                        name="introduce">
                        </textarea>
                    </div>
                  </b-col>

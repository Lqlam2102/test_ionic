...
import AccordionInfor from "../../components/AccordionInfor.vue";
              ...
              <div class="tab-pane active" id="overview-tab" role="tabpanel">
                <b-row>
                  ...
                  <b-col md="8">
                    <b-card no-body>
                      <b-card-body>
                        <AccordionInfor title="Thông tin cá nhân">
                          <div class="table-responsive">
                            <table class="table table-borderless mb-0">
                              <tbody>
                                <tr>
                                  <th
                                    class="ps-0 fw-normal"
                                    style="width: 40%"
                                    scope="row"
                                  >
                                    Họ và tên:
                                ...
                                <tr>
                                  <th class="ps-0 fw-normal" scope="row">
                                    Giới tính:
                                  </th>
                                  <td class="text-muted">
                                    {{

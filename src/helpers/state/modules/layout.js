...
export const actions = {
  ...
  changeMode({ commit }, { mode }) {
    ...
    if (mode === 'dark') {
      ...
      document.documentElement.style.setProperty('--vz-vertical-menu-bg', '#333333');
    } else {
      document.documentElement.setAttribute("data-layout-mode", "light");
      document.documentElement.style.setProperty('--vz-vertical-menu-bg', '#ffffff');
    }
  },

...
<template>
  <LayoutPortal isSticky isLight>
    <section class="section counting-section" style="min-height: 100vh">
      <div class="container">
        <div
          class="mt-5"
          ...
          :key="index"
        >
          <h4 class="section-title text-warning mb-3 text-uppercase">
            {{ application.title }}
          </h4>
          <b-row
        ...
        >
          <h4 class="text-white">KHÔNG ĐƯỢC QUYỀN TRUY CẬP ỨNG DỤNG NÀO!</h4>
        </div>
        <div
          v-if="!applications.length && isLoadingApp"
          class="text-center p-3"
...
.counting-section {
  background: url("@/assets/images/intro_page/couting_bg.jpg") no-repeat center;
